...
docker run --detach --name=mysql_parcelsize --mount type=bind,src=/vagrant/scripts,dst=/docker-entrypoint-initdb.d/ \
--network=bridge-network -p 3306:3306 --env="MYSQL_ROOT_PASSWORD=mypass" mysql:5.7
